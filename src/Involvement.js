  ...
  <>
    ...
    <section id="involvement" style={{
      ...
      <div style={cardStyle}>
        ...
        <img
          src={`${process.env.PUBLIC_URL}/images/Dance.jpg`}
          alt="DCGT"
      ...
      <div style={cardStyle}>
        ...
        <img
          src={`${process.env.PUBLIC_URL}/images/Jazz.jpg`}
          alt="Group Pic"
          style={{ width: '100%', maxWidth: '400px', borderRadius: '12px'}}
          />
      </div>
      ...
      <div style={cardStyle}>
        ...
        <ul style={{ marginTop: '0.5rem', paddingLeft: '1.25rem', lineHeight: '1.6' }}>
          ...
          <li>Unitarian Universalist Congregation of Atlanta - helped distribute food for mobile food drive</li>
        </ul>
      </div>
    </section>
